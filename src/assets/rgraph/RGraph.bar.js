...
RGraph.Bar = function (conf) {
  ...
  this.draw = function () {
    ...
    //
    if (
      (properties.variant == 'pyramid' || properties.variant == 'dot') &&
        ...
        if (typeof this.data[i] == 'object') {
          var value =
            properties.grouping === 'grouped'
              ? Number(RGraph.arrayMax(this.data[i], true))
              : Number(RGraph.arraySum(this.data[i]));
        } else {
  ...
  this.drawbars = function () {
    ...
    for (i = 0, len = this.data.length; i < len; i += 1) {
      ...
      if (RGraph.arraySum(this.data[i]) < 0) {
        var height =
          (RGraph.arraySum(this.data[i]) + this.scale2.min) / (this.scale2.max - this.scale2.min);
      } else {
        var height =
          (RGraph.arraySum(this.data[i]) - this.scale2.min) / (this.scale2.max - this.scale2.min);
      }
      ...
      var y =
        xaxispos == 'center'
          ? (this.canvas.height - this.marginTop - this.marginBottom) / 2 + this.marginTop - height
      ...
      if (typeof this.data[i] == 'number') {
        ...
        if (variant == 'sketch') {
          ...
          if (variant == 'glass') {
            RGraph.roundedRect({
              ...
              width: barWidth,
              height: height,
              radius: RGraph.isNumber(properties.cornersRoundRadius)
          ...
          if (variant == '3d') {
            ...
            if (this.data[i] >= 0) {
              ...
              this.context.lineTo(
                x + hmargin + properties.variantThreedOffsetx,
                y - properties.variantThreedOffsety
              );
              this.context.lineTo(
                x + hmargin + properties.variantThreedOffsetx + barWidth,
                y - properties.variantThreedOffsety
              );
            ...
            this.context.lineTo(
              ...
              this.data[i] < 0 && xaxispos === 'bottom'
                ? this.getYCoord(0)
                : this.data[i] < 0 &&
                    y - properties.variantThreedOffsety < this.marginTop + this.halfgrapharea
            ...
            this.context.lineTo(
              ...
              this.data[i] < 0 &&
                y - properties.variantThreedOffsety + height < this.marginTop + this.getYCoord(0)
            ...
            this.context.roundRect(
              ...
              this.data[i] > 0
                ? [
                    RGraph.isNumber(properties.cornersRoundRadius)
                      ? properties.cornersRoundRadius - 3
                      : 5,
                    0,
                    0,
                    0
        ...
        for (j = 0; j < dataset.length; ++j) {
          ...
          var totalHeight =
            (RGraph.arraySum(dataset) / this.scale2.max) *
            (this.canvas.height - hmargin - this.marginTop - this.marginBottom);
          ...
          if (variant == '3d') {
            ...
            if (j == 0) {
              ...
              this.context.lineTo(
                startX + properties.variantThreedOffsetx + hmargin,
                y - properties.variantThreedOffsety
              );
              this.context.lineTo(
                startX + properties.variantThreedOffsetx + barWidth + hmargin,
                y - properties.variantThreedOffsety
              );
            ...
            this.context.lineTo(
              startX + barWidth + hmargin + properties.variantThreedOffsetx,
              y - properties.variantThreedOffsety
            );
            this.context.lineTo(
              startX + barWidth + hmargin + properties.variantThreedOffsetx,
        ...
        for (j = 0; j < this.data[i].length; ++j) {
          ...
          var height =
            ((this.data[i][j] + (this.data[i][j] < 0 ? this.scale2.min : -1 * this.scale2.min)) /
          ...
          if (variant == '3d') {
            ...
            if (this.data[i][j] >= 0) {
              ...
              this.context.lineTo(
                startX + hmarginGrouped + properties.variantThreedOffsetx,
                startY - properties.variantThreedOffsety
              );
              this.context.lineTo(
                startX + properties.variantThreedOffsetx + individualBarWidth - hmarginGrouped,
                startY - properties.variantThreedOffsety
              );
            ...
            this.context.lineTo(
              ...
              this.data[i][j] < 0
                ? this.getYCoord(0) +
                    Math.abs(height) -
                    properties.variantThreedOffsety -
            ...
            this.context.lineTo(
              startX + individualBarWidth - hmarginGrouped + properties.variantThreedOffsetx,
              this.data[i][j] < 0 &&
                startY + height - properties.variantThreedOffsety < this.getYCoord(0)
                ? this.getYCoord(0)
            ...
            this.context.lineTo(
              ...
              +this.data[i][j] < 0 && startY + height - 5 < this.getYCoord(0)
                ? height > this.properties.variantThreedOffsety
                  ? this.getYCoord(0) + height - this.properties.variantThreedOffsety
                  : this.getYCoord(0)
                : startY + height - properties.variantThreedOffsety
            );
  ...
  this.getShape = function (e) {
    ...
    for (var i = 0, len = coords.length; i < len; i += 1) {
      ...
      if (
        ...
        while (
          idx >=
          (typeof obj.data[dataset] === 'object' && obj.data[dataset]
            ? obj.data[dataset].length
            : 1)
        ) {
        ...
        return {
          ...
          label:
            properties.xaxisLabels && typeof properties.xaxisLabels[dataset] === 'string'
              ? properties.xaxisLabels[dataset]
              : null,
          dataset: dataset,
          index: idx,
          sequentialIndex: i
      ...
      if (mouseX >= left && mouseX <= left + width) {
        if (properties.tooltips) {
          var tooltip = RGraph.parseTooltipText
            ? RGraph.parseTooltipText(properties.tooltips, i)
            : properties.tooltips[i];
        }
  ...
  this.getValue = function (arg) {
    ...
    if (properties.xaxisPosition == 'center') {
      var value =
        ((this.grapharea / 2 - (mouseY - properties.marginTop)) / this.grapharea) *
        (this.scale2.max - this.scale2.min);
      value *= 2;
      ...
      var value =
        ((this.grapharea - (mouseY - properties.marginTop)) / this.grapharea) *
        (this.scale2.max - this.scale2.min);
  ...
  this.highlight = function (shape) {
    if (typeof properties.highlightStyle === 'function') {
      ...
      typeof properties.highlightStyle === 'string' &&
      properties.highlightStyle === 'invert'
    ) {
  ...
  this.parseColors = function () {
    ...
    properties.backgroundBarsColor1 = this.parseSingleColorForGradient(
      properties.backgroundBarsColor1
    );
    properties.backgroundBarsColor2 = this.parseSingleColorForGradient(
      properties.backgroundBarsColor2
    );
    properties.backgroundGridColor = this.parseSingleColorForGradient(
    ...
    if (properties.grouping == 'stacked') {
      ...
      for (var i = 0; i < coords.length; ++i) {
        if (coords[i]) {
          ...
          var xaxispos = properties.xaxisPosition;
          var xaxis_ycoord =
            (this.canvas.height - this.marginTop - this.marginBottom) / 2 + this.marginTop;
  ...
  this.drawLabelsAbove = this.drawAboveLabels = function () {
    var labels = properties.labelsAbove,
      ...
      bold =
        typeof properties.labelsAboveBold === 'boolean'
          ? properties.labelsAboveBold
          : properties.textBold,
      italic =
        typeof properties.labelsAboveItalic === 'boolean'
          ? properties.labelsAboveItalic
      ...
      size =
        typeof properties.labelsAboveSize === 'number'
          ? properties.labelsAboveSize
          : properties.textSize,
      ...
      for (var i = 0, len = data.length, sequentialIndex = 0; i < len; i += 1) {
        ...
        if (typeof data[i] === 'number' && data[i] >= 0) {
          ...
          RGraph.text({
            ...
            text: specific
              ? specific[sequentialIndex] || ''
              : RGraph.numberFormat({
                  object: this,
                  number: Number(typeof data[i] === 'object' ? data[i][0] : data[i]).toFixed(
                    decimals
                  ),
                  value: Number(typeof data[i] === 'object' ? data[i][0] : data[i]).toFixed(
                    decimals
                  ),
                  unitspre: unitsPre,
                  unitspost: unitsPost,
          ...
          for (var j = 0, len2 = data[i].length; j < len2; j += 1) {
            ...
            RGraph.text({
              ...
              y:
                properties.xaxisPosition === 'top'
                  ? coords2[i][j][1] + coords2[i][j][3] + 5
                  : coords2[i][j][1] + (data[i][j] < 0 ? coords2[i][j][3] + offsety + 5 : -offsety),
              text: specific
                ? specific[sequentialIndex] || ''
                : RGraph.numberFormat({
                    object: this,
      ...
      for (var i = 0, len = data.length, sequentialIndex = 0; i < len; i += 1) {
        if (typeof data[i] === 'object') {
          ...
          RGraph.text({
            ...
            y:
              coords2[i][0][1] +
              (data[i][0] < 0 ? coords2[i][0][3] : 0) +
              (properties.xaxisPosition === 'top'
                ? coords2[i].reduce((acc, curr) => (acc += curr[3]), 0) + 3 + offsety
                : -3 - offsety),
            text: specific
              ? specific[sequentialIndex] || ''
              : RGraph.numberFormat({
    ...
    function iterator() {
      ...
      for (let i = 0, len = obj.data.length; i < len; i += 1) {
        if (frame > opt.startFrames[i]) {
          ...
          obj.data[i] =
            typeof obj.data[i] === 'object' && obj.data[i]
              ? RGraph.arrayPad([], obj.data[i].length, 0)
              : RGraph.isNullish(obj.data[i])
                ? null
                : 0;
        }
      }
  ...
  this.colorwave = this.colorWave = function () {
    ...
    function iterator() {
      ...
      for (var i = 0, len = colors.length; i < len; i += 1) {
        if (
          frame > opt.startFrames[i] &&
          colors[i].match(/^rgba?\(([0-9 ]+),([0-9 ]+),([0-9 ]+)(,([ 0-9.]+)?)\)/)
        ) {
          // DO NOT USE SPACES!
  ...
  this.drawErrorbars = function () {
    ...
    for (var i = 0; i < coords.length; ++i) {
      ...
      if (
        typeof this.data[groupedIndexes[0]] === 'object' &&
        !RGraph.isNullish(this.data[groupedIndexes[0]])
      ) {
        var isGrouped = true,
      ...
      // Set the halfwidth
      var halfwidth =
        errorbars[i] && typeof errorbars[i][4] === 'number'
          ? errorbars[i][4] / 2
          : default_halfwidth;
      ...
      if (typeof errorbars[i] === 'number') {
        ...
        if (length) {
          this.path(
            'b % % l % % l % % l % % s %',
            barX + barW / 2,
            (typeof this.data[i] === 'number' && this.data[i] < 0) ||
              (isGrouped && this.data[group][subgroup] < 0)
              ? barY + barH
              : barY,
            barX + barW / 2,
            (typeof this.data[i] === 'number' && this.data[i] < 0) ||
            ...
            (typeof this.data[i] === 'number' && this.data[i] < 0) ||
              (isGrouped && this.data[group][subgroup] < 0)
              ? Math.round(barY + barH + length)
              : Math.round(barY - length),
            barX + barW / 2 + halfwidth,
            (typeof this.data[i] === 'number' && this.data[i] < 0) ||
              (isGrouped && this.data[group][subgroup] < 0)
              ? Math.round(barY + barH + length)
        ...
        if (!RGraph.isNullish(errorbars[i][0])) {
          this.path(
            ...
            barX + barW / 2,
            barY +
              (this.data[i] < 0 ? barH : 0) +
              (isGrouped && this.data[group][subgroup] < 0 ? barH : 0),
            barX + barW / 2,
            barY -
              positiveLength +
              (this.data[i] < 0 ? barH : 0) +
              (isGrouped && this.data[group][subgroup] < 0 ? barH : 0),
            barX + barW / 2 - halfwidth,
            Math.round(barY - positiveLength) +
              (this.data[i] < 0 ? barH : 0) +
              (isGrouped && this.data[group][subgroup] < 0 ? barH : 0),
            barX + barW / 2 + halfwidth,
            Math.round(barY - positiveLength) +
        ...
        if (typeof errorbars[i][1] === 'number') {
          ...
          this.path(
            ...
            Math.round(coords[i][1] + negativeLength) +
              ...
              (isGrouped && this.data[group][subgroup] < 0 ? barH : 0),
            barX + barW / 2 + halfwidth,
            Math.round(barY + negativeLength) +
              (this.data[i] < 0 ? barH : 0) +
              (isGrouped && this.data[group][subgroup] < 0 ? barH : 0),
            color
          );
  ...
  this.roundedCornersRect = function (x, y, width, height) {
    ...
    this.context.arcTo(
      ...
      width,
      height,
      Math.min(height / 2, properties.cornersRoundRight ? radiusRight : 0)
    );
    ...
    this.context.arcTo(
      ...
      radiusLeft,
      0,
      Math.min(height / 2, this.properties.cornersRoundLeft ? radiusLeft : 0)
    );
  ...
  this.roundedCornersRectNegative = function (x, y, width, height) {
    ...
    this.context.arcTo(
      ...
      0,
      0,
      Math.min(height / 2, properties.cornersRoundLeft ? radiusLeft : 0)
    );
  ...
  this.install3DAxisNegativeClip = function () {
    this.path(
      ...
      this.canvas.height - this.marginBottom,
      this.canvas.width - this.marginRight + this.properties.variantThreedOffsetx,
      this.canvas.height - this.marginBottom - this.properties.variantThreedOffsety,
      this.canvas.width - this.marginRight + this.properties.variantThreedOffsetx,
      this.getYCoord(0) - this.properties.variantThreedOffsety,
      this.canvas.width - this.marginRight,
      this.getYCoord(0)
    );
  };
  ...
  this.getKeyNumDatapoints = function () {
    ...
    for (let i = 0; i < this.data.length; ++i) {
      if (RGraph.isArray(this.data[i])) {
        num = Math.max(num, this.data[i].length);
      }
    }
...
RGraph.CombinedChart = function () {
    ...
    if (this.objects[i].type == 'line') {
      ...
      obj.set(
        ...
        (this.objects[0].canvas.width -
          this.objects[0].get('marginRight') -
          this.objects[0].get('marginLeft')) /
  ...
  if (resizable_object) {
    ...
    function myOnresizebeforedraw(obj) {
      ...
      obj.set(
        'marginInner',
        (obj.canvas.width - marginLeft - marginRight) / (obj.original_data[0].length * 2)
      );
    }
  ...
  if (RGraph.isArray(this.objects)) {
    for (var i = 0; i < this.objects.length; ++i) {
      if (this.objects[i].properties['combinedEffect']) {
        ...
        var options = this.objects[i].properties['combinedEffectOptions']
            ? eval('(' + this.objects[i].properties['combinedEffectOptions'] + ')')
            : null,
...
RGraph.SegmentedBar = function (conf) {
  ...
  this.foreground = new RGraph.Bar({
    ...
    for (var i = 0; i <= count; ++i) {
      obj.path(
        'cr 0 % 1000 %',
        obj.getYCoord((i / count) * seg.foreground.scale2.max) - lw / 2,
        lw
      );
    }
  });
  ...
  this.foreground.set({
    yaxisLabelsOffsety:
      (this.foreground.canvas.height -
        this.foreground.properties.marginTop -
        this.foreground.properties.marginBottom) /
      seg.properties.segmentsCount /
      2
  });
